					...
					<div className="h-full">
						<div className="flex p-10">
							...
							<div className="mb-auto mt-auto max-w-lg">
								...
								<p className="font-semibold mb-5">Fitness & Wellbeing Coach</p>
								<p className="leading-8 mb-10"> BeachFit and Wellbeing was established in 2012 on the beautiful Coogee Beach. Our aim is to inspire our members to be the fittest, healthiest version of themselves and push to their limits, whatever they might be. Using a variety of equipment and techniques, no two workouts are ever the same, keeping things fresh and the body guessing.
