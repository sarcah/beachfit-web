...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center">
        ...
        <ul id="menu" className="font-sans text-white uppercase text-lg lg:flex items-center hidden">
          <Link to="/about" className="menuLink py-2 px-6 flex hover:underline">About</Link>
          <Link to="/contact" className="menuLink py-2 px-6 flex hover:underline">Contact</Link>
          ...
          <Link to="/faq" className="menuLink py-2 px-6 flex hover:underline">Blog</Link>
          <Link to="/faq" className="menuLink py-2 px-6 flex hover:underline">Timetable</Link>
          <Link to="/services" className="menuLink py-2 px-6 flex hover:underline">Pricing</Link>
