...
import "./navbar.css";
import background from "./4jILtYYg.jpeg";
            ...
            <div className="container mx-auto flex items-center bg-white">
              <div className="flex w-1/2 pl-4 text-sm">
                <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                  <li className="mr-2">
                    <Link className="inline-block py-2 px-2 text-black no-underline hover:underline" to="/about">About</Link>
                  </li>
                  <li className="mr-2">
                    <a className="inline-block py-2 px-2 text-black no-underline hover:underline" href="#">Contact</a>
                  </li>
                  <li className="mr-2">
                    <a className="inline-block py-2 px-2 text-black no-underline hover:underline" href="#">FAQ</a>
                  </li>
                  <li className="mr-2">
                    <a className="inline-block py-2 px-2 text-black no-underline hover:underline" href="post_vue.html">Timetable</a>
                  </li>
                  <li className="mr-2">
                    <a className="inline-block py-2 px-2 text-black no-underline hover:underline" href="post_vue.html">Pricing</a>
                  </li>
                </ul>
              </div>
              <div className="flex w-1/2 justify-end content-center">
                <a className="inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar"
